...
from src.utils.conv import ConvLayer, PatchEmbed, D_ConvLayer
from src.utils.kan import KANBlock


class UKAN(nn.Module):
    def __init__(self, num_classes, channels=3, deep_supervision=False, img_size=224, patch_size=16, in_chans=3,
        ...
        self.encoder1 = ConvLayer(channels, kan_input_dim // 8)
