...
class KANLinear(nn.Module):
    ...
    def update_grid(self, x: torch.Tensor, margin=0.01):
        ...
        # sort each channel individually to collect dataset distribution
...
class UKAN(nn.Module):
    def __init__(self, num_classes=1, channels=3, deep_supervision=False, img_size=224, patch_size=16, in_chans=3,
