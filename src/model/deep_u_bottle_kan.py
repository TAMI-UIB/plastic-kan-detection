...
from .components.bottleneck import BottleNeckKAN
...
class DeepUBottleKAN(nn.Module):
    """
    DeepUNet: A Deep Fully Convolutional Network for Pixel-level Sea-Land Segmentation
    https://arxiv.org/abs/1709.00201
    """
    def __init__(self, channels, hidden_channels, image_size, n_classes=1, BN=True):
        super(DeepUBottleKAN, self).__init__()
        ...
        self.bottleneck = BottleNeckKAN(image_size)
